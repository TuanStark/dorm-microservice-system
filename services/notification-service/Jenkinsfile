pipeline {
    ...
    stages {
        ...
        stage('Unit Tests') {
            ...
            post {
                always {
                    publishTestResults testResultsPattern: 'services/notification-service/coverage/test-results.xml'
                    publishCoverage adapters: [
                        jacocoAdapter('services/notification-service/coverage/lcov.info')
